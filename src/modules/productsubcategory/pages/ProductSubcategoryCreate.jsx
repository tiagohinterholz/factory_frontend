import { useProductSubcategoryForm } from "@/modules/productsubcategory/hooks/useProductSubcategoryForm"
...
export default function ProductSubcategoryCreate() {
  const { form, onSubmit } = useProductSubcategoryForm()
  const {
    register,
    formState: { errors, isSubmitting },
  } = form

  const { productCategories, loading } = useProductCategoryOptions()
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="max-w-xl mx-auto">
        ...
        <h1 className="text-xl font-semibold text-ink tracking-tight mb-2">Nova Subcategoria</h1>
        <p className="text-slate-400 font-medium text-sm mb-8">
          Adicione uma subcategoria ao catálogo de produtos
        </p>
