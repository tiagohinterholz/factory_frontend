import { useProductCategoryForm } from "@/modules/productcategory/hooks/useProductCategoryForm"
...
export default function ProductCategoryCreate() {
  const { form, onSubmit } = useProductCategoryForm()
  const {
    register,
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="max-w-xl mx-auto">
        ...
        <h1 className="text-xl font-semibold text-ink tracking-tight mb-2">Nova Categoria</h1>
        <p className="text-slate-400 font-medium text-sm mb-8">
          Adicione uma categoria ao catálogo de produtos
        </p>
