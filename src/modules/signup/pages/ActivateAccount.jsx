...
import { useActivateAccountForm } from "@/modules/signup/hooks/useActivateAccountForm"

export default function ActivateAccount() {
  const { uidb64, token } = useParams()
  const { form, onSubmit } = useActivateAccountForm({ uidb64, token })
  const {
    register,
    watch,
    setValue,
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card-premium">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-lg font-semibold text-ink tracking-tight">Ative sua conta</h1>
              <p className="text-[12.5px] text-muted">Escolha uma senha pra começar a usar</p>
            </div>
          </div>
