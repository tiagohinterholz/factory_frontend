import { useVehicleModelEditForm } from "@/modules/vehiclemodel/hooks/useVehicleModelEditForm"
...
export default function VehicleModelEdit() {
  const { form, onSubmit, loading, handleDelete } = useVehicleModelEditForm()
  const {
    register,
  ...
  if (loading || loadingManufacturers) {
    return (
    ...
    <div className="p-6 space-y-6">
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-xl font-semibold text-ink tracking-tight mb-2">Editar Modelo</h1>
